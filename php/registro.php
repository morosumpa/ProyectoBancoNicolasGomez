...
<div class="container">
  <form class="colorforms" action="modelo.php" method="post">
            <label class="colorcampostxt" for="campo1">DNI:</label>
            <input type="text" id="campo1" name="campo1" required>

            <label class="colorcampostxt" for="campo2">Nombre:</label>
            <input type="text" id="campo2" name="campo2" required>

            <label class="colorcampostxt" for="campo3">Apellidos:</label>
            <input type="text" id="campo3" name="campo3" required>

            <label class="colorcampostxt" for="campo4">Email:</label>
            <input type="email" id="campo4" name="campo4" required>

            <label class="colorcampostxt" for="campo5">Fecha de nacimiento:</label>
            <input type="date" id="campo5" name="campo5" required>

            <label class="colorcampostxt" for="campo6">Foto:</label>
            <input type="text" id="campo6" name="campo6" required>

            <label class="colorcampostxt" for="campo7">Dirección:</label>
            <input type="text" id="campo7" name="campo7" required>

            <label class="colorcampostxt" for="campo8">Codigo postal:</label>
            <input type="text" id="campo8" name="campo8" required>

            <label class="colorcampostxt" for="campo9">Ciudad:</label>
            <input type="text" id="campo9" name="campo9" required>

            <label class="colorcampostxt" for="campo10">Provincia:</label>
            <input type="text" id="campo10" name="campo10" required>

            <label class="colorcampostxt" for="campo11">País:</label>
            <input type="text" id="campo11" name="campo11" required>

            <label class="colorcampostxt" for="campo12">Contraseña:</label>
            <input type="password" id="campo12" name="campo12" required>
